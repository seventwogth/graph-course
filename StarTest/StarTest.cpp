...
HRESULT InitDevice()
{
    ...
    #endif
    hr = D3DX10CreateEffectFromFile( L"StarTest.fx", NULL, NULL, "fx_4_0", dwShaderFlags, 0,
    ...
    for (int i = 0; i < numRays * 2; i++)
    {
        ...
        SimpleVertex v1;
        v1.Pos = D3DXVECTOR3(r1 * sin(angle1), r1 * cos(angle1), 0.5f);

        SimpleVertex v2;
        v2.Pos = D3DXVECTOR3(r2 * sin(angle2), r2 * cos(angle2), 0.5f);
...
void Render()
{
    ...
    float ClearColor[4] = { 0.2f, 0.0f, 0.375f, 1.0f }; // red,green,blue,alpha
